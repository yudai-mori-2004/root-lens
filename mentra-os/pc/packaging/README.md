...
`rootlens_import/assets/rootlens.png` is an exact copy of the existing `app/assets/icon.png`.
...
Run from `mentra-os/pc/`. This produces `RootLens Import.app`. Copy it to Applications
