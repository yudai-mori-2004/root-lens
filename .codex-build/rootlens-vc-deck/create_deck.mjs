...
const TMP_DIR = path.join(workspaceDir, ".codex-build/rootlens-vc-deck");
const FINAL_PPTX = path.join(workspaceDir, "output/presentations/rootlens-vc-deck-v32.pptx");
...
const result = await finalizePresentation({
  ...
  receiptPath: path.join(TMP_DIR, "rootlens-vc-deck-v32.validation.json"),
});
