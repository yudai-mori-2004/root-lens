...
> **発注停止:** この表は2026-09-07のM5Stamp ESP32P4案である。初号機はRaspberry Pi 5分離型へ変更したため、この表から注文しない。現在の発注表は[2026-09-11の低価格経路](../research/existing-glasses/LOW-COST-DECISION-2026-09-11.md#raspberry-pi-5分離型の購入表)を使う。
