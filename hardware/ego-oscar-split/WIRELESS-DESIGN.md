...
> **第二段階の設計:** この文書はM5Stamp ESP32P4で頭部完結・無線化する小型化案である。現在の初号機はRaspberry Pi 5分離型とし、[2026-09-11の低価格経路](../research/existing-glasses/LOW-COST-DECISION-2026-09-11.md)を先に実装する。
