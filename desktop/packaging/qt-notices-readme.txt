RootLens uses unmodified, dynamically loaded PySide6 / Qt 6.11.2 community libraries.
The Qt Multimedia plugin includes FFmpeg 7.1.5 under LGPL 2.1 or later.
Qt and PySide6 are used under LGPLv3; their corresponding library files remain separate in the app bundle.
License texts, upstream attributions, and source locations are included here.
Qt/PySide6 source: https://download.qt.io/official_releases/QtForPython/pyside6/PySide6-6.11.2-src/
