...
export const publicPages = {
  ja: {
    ...
    policy: {
      ...
      appBody: "撮影機材をPCに接続し、録画の取り込み、映像・音声の確認、承認済みデータのアップロードを行うアプリケーションです。現場監督者は、当社から招待されたGoogleアカウントでログインして使用します。",
      appAction: "アプリをダウンロード",
      evidenceTitle: "03 証跡の管理",
      evidenceLead: "各撮影データに撮影単位の識別子を付与し、以下の記録と紐付けます。",
  ...
  en: {
    ...
    policy: {
      ...
      appTitle: "RootLens Importer",
      appBody: "This desktop application connects to the capture device to import recordings, review video and audio, and upload approved data. Field supervisors sign in with a Google account invited by RootLens.",
      appAction: "Download the app",
      evidenceTitle: "03 Evidence management",
      evidenceLead: "Each recording receives a recording-unit identifier and is linked to the following records.",
