...
export default function SiteClient({ siteId }: { siteId: string }) {
  ...
  return <div className={styles.shell}><header className={styles.header}><Link className={styles.brand} href="/manage">RootLens</Link><Link className={styles.link} href="/manage">事業所一覧</Link></header><main className={styles.main}>
