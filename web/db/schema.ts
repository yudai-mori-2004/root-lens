...
export const agreementRecords = pgTable("agreement_records", {
  ...
  acceptancePayloadSha256: text("acceptance_payload_sha256").notNull(),
  signerIdentityId: text("signer_identity_id").notNull(),
  signerName: text("signer_name").notNull(),
  phoneLast4: text("phone_last4").notNull(),
  authenticationMethod: text("authentication_method").notNull(),
  acceptedStatement: text("accepted_statement").notNull(),
...
export const operatorInvites = pgTable("operator_invites", {
  ...
  acceptanceRecordId: text("acceptance_record_id"),
  acceptanceFileId: text("acceptance_file_id"),
  acceptanceStartedAt: timestamp("acceptance_started_at", { withTimezone: true }),
  acceptanceIdentityId: text("acceptance_identity_id"),
  acceptancePhoneLast4: text("acceptance_phone_last4"),
  acceptanceSignerName: text("acceptance_signer_name"),
  processingOwner: text("processing_owner"),
  processingStartedAt: timestamp("processing_started_at", { withTimezone: true }),
  createdAt: timestamp("created_at", { withTimezone: true }).notNull().defaultNow(),
}, (table) => [index("operator_invites_person_idx").on(table.personId)]);

export const siteRegistrationAttempts = pgTable("site_registration_attempts", {
  ...
  staffConsentsFolderId: text("staff_consents_folder_id").notNull(),
  approvedDataFolderId: text("approved_data_folder_id").notNull(),
  siteAgreementId: text("site_agreement_id").notNull(),
  siteAgreementFileId: text("site_agreement_file_id").notNull(),
  staffConsentId: text("staff_consent_id").notNull(),
  staffConsentFileId: text("staff_consent_file_id").notNull(),
  processingOwner: text("processing_owner"),
  processingStartedAt: timestamp("processing_started_at", { withTimezone: true }),
